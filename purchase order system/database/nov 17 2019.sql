...
insert  into `addresses`(`addressid`,`address`,`city`,`zipcode`,`province`) values (1,'25 Ledesma St. taaePoblacion','data report','9800','Sultan Kudarat'),(2,'25 Ledesma St. Purok Poblacion','Tacurong City','9800','Sultan Kudarat'),(3,'Purok Ilang Ilang','Tacurong City','9800','Sultan Kudarat'),(4,'27 Roxas Ave, Poblacion District','Davao City','8000','Davao del Sur'),(5,'742, Door 4, Diajade Building, Near USEP, Corner Iñigo St., ','Davao City','8000','Davao del Sur'),(6,'Padre Gomez St, Poblacion District','Davao City','8000','Davao del Sur'),(7,'Sales Jaltan Building, Calinan District','Davao City','8000','Davao del Sur'),(8,'7 Nicasio Torres St, Agdao','Davao City','8000',' Davao del Sur');
...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,1,2,1,11000),(2,91,1,2,84990),(3,89,23,2,27485),(4,32,3,3,6300),(5,46,1,4,20999),(6,49,3,4,74995),(7,56,4,4,74995);
...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`,`isdeleted`) values (1,1,'te',1,2,1,'CANCELED',0,11000,'0001-01-01','2019-11-16','te',0),(2,1,'rasol',4,2,1,'PENDING',0,112475,'0000-00-00','2019-11-16','kjsdkjaskjadks',0),(3,1,'asdasd',1,1,2,'PENDING',0,6300,'0000-00-00','2019-11-17','asdasd',0),(4,1,'laptops',2,1,1,'PENDING',0,545964,'0000-00-00','2019-11-17','asdadadasd',0);
...
insert  into `storeinformation`(`storename`,`contactdetailid`) values ('Gwapo si RAsol',1);
