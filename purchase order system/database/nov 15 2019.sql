...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,25,44700,1,3),(2,9,22300,1,1),(3,36,154980,2,2);
...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`,`isdeleted`) values (1,3,'test',1,1,1,'RECEIVED',222,67000,'2019-11-13','2019-11-07','tesssss',0),(2,3,'test',1,2,2,'PENDING',50000,154980,'0000-00-00','2019-11-13','test',0);
