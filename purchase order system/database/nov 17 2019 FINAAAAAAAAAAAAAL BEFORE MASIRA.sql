...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`,`isdeleted`) values (1,1,'test',1,1,1,'RECEIVED',0,11000,'0001-01-01','2019-11-17','asdasd',0),(2,1,'asd',1,1,1,'RECEIVED',0,16000,'0000-00-00','2019-11-17','asdasd',0);
