...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,1,2,1,5500);
...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`,`isdeleted`) values (1,1,'test',1,1,1,'RECEIVED',0,11000,'0000-00-00','2019-11-17','asdasd',0);
