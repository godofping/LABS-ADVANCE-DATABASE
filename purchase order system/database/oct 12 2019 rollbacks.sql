...
insert  into `basicinformations`(`basicinformationid`,`firstname`,`middlename`,`lastname`,`gender`,`birthdate`) values (1,'Rex Louis','Paradero','Roncesvalles','1','0000-00-00');
