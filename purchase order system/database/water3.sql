...
CREATE TABLE `containertypes` (
  ...
  `containersrp` float DEFAULT NULL,
  PRIMARY KEY (`containertypeid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

/*Data for the table `containertypes` */

insert  into `containertypes`(`containertypeid`,`containertype`,`containersrp`) values (1,'SLIM WATER CONTAINER WITH FAUCET (5 GALLONS CAPACITY)',NULL),(2,'SLIM WATER CONTAINER WITH FAUCET (3 GALLONS CAPACITY)',NULL),(3,'ROUND WATER CONTAINER (6 GALLONS CAPACITY)',NULL);
...
CREATE TABLE `orderdetails` (
  ...
  KEY `FK_orderdetails2` (`productcategoryid`),
  KEY `FK_orderdetails3` (`particularid`),
  KEY `FK_orderdetails4` (`containertypeid`),
  CONSTRAINT `FK_orderdetails` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`),
  CONSTRAINT `FK_orderdetails2` FOREIGN KEY (`productcategoryid`) REFERENCES `productcategories` (`productcategoryid`),
  CONSTRAINT `FK_orderdetails3` FOREIGN KEY (`particularid`) REFERENCES `particulars` (`particularid`),
  CONSTRAINT `FK_orderdetails4` FOREIGN KEY (`containertypeid`) REFERENCES `containertypes` (`containertypeid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `particulars` (
  ...
  `particularsrp` float DEFAULT NULL,
  PRIMARY KEY (`particularid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

/*Data for the table `particulars` */

insert  into `particulars`(`particularid`,`particular`,`particularsrp`) values (1,'DISTILLED',NULL),(2,'PURIFIED',NULL),(3,'MINERAL',NULL);
