...
insert  into `categories`(`categoryid`,`categoryname`,`isdeleted`) values (1,'Components',0),(2,'Lap1',1),(3,'Laptops',0),(4,'Peripherals',0),(5,'Phones and Tablets',0),(6,'Software',0);
...
insert  into `subcategories`(`subcategoryid`,`subcategoryname`,`categoryid`,`isdeleted`) values (1,'Casing',1,0),(2,'tae1',1,1);
...
insert  into `suppliers`(`supplierid`,`supplier`,`contactdetailid`,`isdeleted`) values (1,'Apple Inc',18,0),(2,'tae',19,1);
