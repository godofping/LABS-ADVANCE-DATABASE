...
insert  into `staffs`(`staffid`,`basicinformationid`,`designationid`,`datehired`) values (1,1,1,'2019-11-27'),(4,10,2,'2019-11-27');
...
insert  into `staffsaccount`(`staffaccountid`,`staffid`,`username`,`password`) values (1,1,'admin','admin'),(4,4,'cashier','cashier');
