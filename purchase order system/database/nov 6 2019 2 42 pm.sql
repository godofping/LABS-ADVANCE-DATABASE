...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,25,44700,1,3),(2,9,22300,1,1);
