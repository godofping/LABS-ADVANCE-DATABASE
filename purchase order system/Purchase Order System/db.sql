...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,1,2,1,11000),(2,91,1,2,84990),(3,89,23,2,27485);
...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`,`isdeleted`) values (1,1,'te',1,2,1,'CANCELED',0,11000,'0001-01-01','2019-11-16','te',0),(2,1,'rasol',4,2,1,'PENDING',0,112475,'0000-00-00','2019-11-16','kjsdkjaskjadks',0);
