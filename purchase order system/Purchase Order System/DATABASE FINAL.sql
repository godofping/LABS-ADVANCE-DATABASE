...
insert  into `basicinformations`(`basicinformationid`,`firstname`,`middlename`,`lastname`,`gender`,`birthdate`) values (1,'Rex Louis','Paradero','Roncesvalles','Male','1997-09-23'),(2,'Romano','Liwag','Mercado','Male','1980-11-12'),(3,'ASD','ASD','SDA','Male','2019-11-17'),(4,'1','asd1','asdasd1','Male','2019-11-17'),(5,'asdasd','asdad','asdad','Male','2019-11-17');
...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,1,2,1,5500),(2,31,2,2,6400),(3,109,4,2,800);
...
insert  into `staffs`(`staffid`,`username`,`password`,`contactdetailid`,`basicinformationid`,`staffpositionid`) values (1,'admin','admin',2,1,1),(3,'aa','aa',12,5,2);
