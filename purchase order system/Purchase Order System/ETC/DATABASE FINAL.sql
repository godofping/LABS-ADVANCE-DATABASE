...
insert  into `addresses`(`addressid`,`address`,`city`,`zipcode`,`province`) values (1,'22 Ledesma St., Purok Poblacion','Tacurong City','9800','Sultan Kudarat'),(2,'25 Ledesma St. Purok Poblacion','Tacurong City','9800','Sultan Kudarat'),(3,'Purok Ilang Ilang','Tacurong City','9800','Sultan Kudarat'),(4,'27 Roxas Ave, Poblacion District','Davao City','8000','Davao del Sur'),(5,'742, Door 4, Diajade Building, Near USEP, Corner Iñigo St., ','Davao City','8000','Davao del Sur'),(6,'Padre Gomez St, Poblacion District','Davao City','8000','Davao del Sur'),(7,'Sales Jaltan Building, Calinan District','Davao City','8000','Davao del Sur'),(8,'7 Nicasio Torres St, Agdao','Davao City','8000',' Davao del Sur'),(9,'ASD1','ADS1','123','ASDA'),(10,'asd1','asd','123','123'),(11,'123','12','123','123'),(12,'44 Ledesma','Tacurong City','9800','Sultan Kudarat');
...
insert  into `basicinformations`(`basicinformationid`,`firstname`,`middlename`,`lastname`,`gender`,`birthdate`) values (1,'Rex Louis','Paradero','Roncesvalles','Male','1997-09-23'),(2,'Romano','Liwag','Mercado','Male','1980-11-12'),(3,'ASD','ASD','SDA','Male','2019-11-17'),(4,'1','asd1','asdasd1','Male','2019-11-17'),(5,'Clarie','Sagolili','Jadraque','Female','1997-11-17');
...
insert  into `categories`(`categoryid`,`categoryname`) values (1,'Components'),(3,'Laptops'),(4,'Peripherals'),(5,'Phones and Tablets'),(6,'Software');
...
insert  into `customers`(`customerid`,`contactdetailid`,`basicinformationid`) values (1,3,2);
...
insert  into `products`(`productid`,`productname`,`productdescription`,`subcategoryid`,`productsku`,`productprice`) values (1,'SilverStone Tundra SST-TD02-E 2X120mm All-in-One CPU Liquid Cooler','Easy installation with aluminum clips and steel back-plate\r\n',1,'FAN-SILVERSTONE TUNDRA TD02-E',5500.05),(4,'The NVIDIA® GeForce® RTX 2080 SUPER™ is powered by the award','The NVIDIA® GeForce® RTX 2080 SUPER™ is powered by the award',9,'VC-INNO3D RTX2080 SUPER OC X3 8GB DDR6 256BIT',46760),(5,'INNO3D GeForce RTX 2070 SUPER TWIN X2 OC 8GB GDDR6 256-bit Graphics Card (N207S2-08D6X-11801167)','The NVIDIA® GeForce® RTX 2070 SUPER™ is powered by the award',9,'VC-INNO3D RTX2070 SUPER TWIN X2 8GB GDDR6 256B',32940),(6,'INNO3D GeForce RTX 2070 TWIN X2 8GB GDDR6 256-bit Graphics Card (N20702-08D6-1160VA22)','The powerful new GeForce RTX™ 2070 takes advantage of the cu',9,'VC-INNO3D RTX2070 OC8G OC 8GB GDDR6 256BIT',29270),(7,'INNO3D GeForce RTX 2060 TWIN X2 6GB GDDR6 192-bit Graphics Card (N20602-06D6-1710VA23)','The GeForce RTX™ 2060 is powered by the NVIDIA Turing™ archi',9,'VC-INNO3D RTX2060 TWIN X2 6GB GDDR6 192BIT',21060),(8,'INNO3D GeForce RTX 2060 SUPER TWIN X2 OC 8GB GDDR6 256-bit Graphics Card (N206S2-08D6X-1710VA15L)','The NVIDIA® GeForce® RTX 2060 SUPER™ is powered by the award',9,'VC-INNO3D RTX2060 SUPER 8G TWIN X2 OC DDR6 256B',25540),(9,'INNO3D GeForce GTX 1660 Ti TWIN X2 6GB GDDR6 192-bit Graphics Card (N166T2-06D6-1710VA15)','The GeForce® GTX 1660 Ti is built with the breakthrough grap',9,'VC-INNO3D GTX1660TI TWIN X2 6GB DDR6 192BIT',16690),(10,'Gigabyte GeForce RTX 2070 SUPER GAMING OC 8G Graphics Card (GV-N207SGAMING-OC-8GC)','Powered by GeForce® RTX 2070 SUPER™\r\nIntegrated with 8GB GDD',9,'VC-GIGABYTE RTX2070 SUPER GAMING OC 8GB GDDR6 256B',31400),(11,'Gigabyte GeForce RTX 2060 SUPER WINDFORCE OC 8G Graphics Card (GV-N206SWF2OC-8GD)','Powered by GeForce® RTX 2060 SUPER™\r\nIntegrated with 8GB GDD',9,'VC-GIGABYTE RTX2060 SUPER WINDFORCE OC 8G GDDR6 25',24750),(12,'Gigabyte GeForce GTX 1660 Ti WINDFORCE OC 6G Graphics Card (GV-N166TWF2OC-6GD)','The 3D Active Fan provides semi-passive cooling, and the fan',9,'VC-GIGABYTE GTX1660TI WINDFORCE OC 6GB DDR6 192BIT',17600),(13,'ASUS Phoenix PH-GTX1660-O6G GeForce GTX 1660 OC edition 6GB GDDR5 Graphics Card','The ASUS Phoenix GeForce® GTX 1660 OC edition 6GB GDDR5 rock',9,'VC-ASUS GTX1660 PHOENIX O6G 6GB DDR5 192BIT',14200),(14,'ASUS DUAL-GTX1650-O4G GeForce GTX 1650 OC Edition 4GB GDDR5 Graphics Card','The ASUS Dual GeForce® GTX 1650 is built with the breakthrou',9,'VC-ASUS GTX1650 DUAL O4G 4GB DDR5 128BIT',9900),(15,'GALAX GeForce RTX 2070 EX OC 8GB GDDR6 256bit Graphics Card','GALAX GeForce® RTX 2070 EX OC\r\n8GB GDDR6 256-bit DP*3/HDMI',9,'VC-GALAX RTX2070 EXOC 8GB GDDR6 256BIT',23400),(16,'GALAX GeForce RTX 2080 OC 8GB GDDR6 256-bit Graphics Card','The “Xrystlic” double-layered surface graphic card is taking',9,'VC-GALAX RTX2080 OC RGB 8GB DDR6 256BIT',36500),(17,'MSI GeForce RTX 2070 ARMOR 8G OC 256-bit 8GB GDDR6 Graphics Card','GeForce RTX™ gaming GPUs come loaded with next-generation GD',9,'VC-MSI RTX2070 ARMOR RGB 8GB GDDR6 256BIT',29200),(18,'MSI GeForce RTX 2070 GAMING Z 8GB GDDR6 Graphics Card','Core/Memory\r\n\r\nBoost Clock / Memory Speed\r\n1830 MHz / 14Gbps',9,'VC-MSI RTX2070 GAMING Z OC RGB 8GB GDDR6 256BIT',34900),(19,'MSI GeForce RTX 2060 VENTUS 6G OC Graphics Card','Boost Clock / Memory Speed\r\n1710 MHz / 14 Gbps\r\n6GB GDDR6\r\nD',9,'VC-MSI RTX2060 VENTUS OC 6GB GDDR6 192BIT',22300),(20,'ASROCK H110M-HDV H110 LGA1151 mATX MOTHERBOARD','ASRock Super Alloy\r\nSupports 6th Generation Intel® Core™ Pro',6,'MB-ASROCK H110M-HDV',3050),(21,'ASUS TUF X570-PLUS GAMING WI-FI Motherboard','AMD AM4 X570 ATX gaming motherboard with PCIe 4.0, dual M.2,',6,'MB-ASUS TUF X570-PLUS GAMING WI-FI',12200),(22,'ASUS STRIX Z370-F GAMING Motherboard','none',6,'MB-ASUS STRIX Z370-F GAMING',11250),(23,'ASUS STRIX X570-E GAMING Motherboard','AMD X570 ATX gaming motherboard with PCIe 4.0, 2.5 Gbps and ',6,'MB-ASUS STRIX X570-E GAMING',19300),(24,'Kingston ValueRAM 16GB DDR4 2666MHZ SODIMM (KVR26S19D8/16)','Competitively priced ValueRAM memory delivers award-winning ',7,'RAM-KINGSTON 16GB DDR4 PC2666MHZ SODIMM',3600),(25,'Kingston ValueRAM 16GB DDR4 2400MHZ SODIMM (KVR24S17D8/16)','Competitively priced ValueRAM memory delivers award-winning ',7,'RAM-KINGSTON 16GB DDR4 PC2400MHZ SODIMM',3600),(26,'Kingston ValueRAM 8GB DDR4 2666MHZ SODIMM (KVR26S19S8/8)','Competitively priced ValueRAM memory delivers award-winning ',7,'RAM-KINGSTON 8GB DDR4 PC2666MHZ SODIMM',1800),(27,'Crucial 8GB DDR4-2400 Memory Module','Crucial 8GB DDR4-2400 Memory Module',7,'RAM-CRUCIAL 8GB DDR4 PC2400MHZ',1750),(28,'Crucial 4GB DDR4-2400 Memory Module','Crucial 4GB DDR4-2400 Memory Module',7,'RAM-CRUCIAL 4GB DDR4 PC2400MHZ',995),(29,'G.Skill Ripjaws V 16GB (1X16GB) DDR4-2400MHZ F4-2400C15S-16GVR Memory Module','Series: Ripjaws V\r\nMemory Type: DDR4\r\nCapacity: 16GB (16GBx1',7,'RAM-GSKILLS RIPJAWSV16GB F4-2400C15S-16GVR',3850),(30,'G.Skill Trident Z RGB 16GB (8GBx2) 3200MHz DDR4 Dual Channel RGB Memory Kit (F4-3200C16D-16GTZR)','Featuring a completely exposed light bar with vibrant RGB LE',7,'RAM-GSKILLS TRIDENT Z 16GB 2X8G F4-3200C16D-16GTZR',6200),(31,'ASUS TUF Gaming GT501 ATX Mid Tower Case','Supports up to EATX with metal front panel, tempered-glass s',1,'CASE-ASUS TUF GAMING GT501 RGB TG',6400),(32,'Vikings VKS-30 Shield Tempered Glass Gaming Case with 3 RGB Fans','Vikings VKS-30 Shield Tempered Glass Gaming Case with 3 RGB ',1,'CASE-VIKINGS SHIELD VKS-30 RGB TG',2100),(33,'SilverStone Tundra SST-TD02-E 2X120mm All-in-One CPU Liquid Cooler','Easy installation with aluminum clips and steel back-plate\r\n',3,'FAN-SILVERSTONE TUNDRA TD02-E',5500),(34,'Cooler Master X Dream i117 CPU Cooler','Low profile aluminum extrusion fin with only 60mm height\r\nUn',3,'FAN-COOLER MASTER X DREAM I117 CPU COOLER',680),(35,'INTEL 512GB 660P M.2 PCIE NVME 3.0 X4 (6GBPS) (SSDPEKNW512G8X1) SOLID STATE DRIVE','none',8,'SSD-INTEL 512GB 660P NVME M.2',3800),(36,'Seagate 512GB Barracuda 510 PCIE NVME M.2 (ZP512CM30041) Solid State Drive','The BarraCuda SSD is a dependable and cost-effective way to ',8,'SSD-SGTE 512GB BARRACUDA 510 PCIE NVME M.2',5900),(37,'Silverstone Strider Essential Series SST-ST50F-ES230 500W 80 PLUS Power Supply','The Strider Essential series is a line of power supplies des',10,'PS-SILVERSTONE SST-ST50F-ES230 500W 80+',2350),(38,'Cooler Master MasterWatt Lite 600W 80+ Power Supply','Advanced Circuit Design\r\nEntirely Upgrade Quality\r\nExclusive',10,'PS-COOLER MASTER MASTERWATT LITE 600W 80+',3100),(39,'AMD Ryzen 7 3700X','none',5,'CPU-AMD RYZEN 7 3700X (3.6GHZ) UNLOCKED',18700),(40,'AMD Ryzen 5 3600X','Serious High-Definition Gaming\r\nEveryone deserves a powerful',5,'CPU-AMD RYZEN 5 3600X (3.8GHZ) UNLOCKED',14200),(41,'Intel Celeron G4900 Processor (2M Cache, 3.10 GHz)','Intel Celeron G4900 Processor (2M Cache, 3.10 GHz)',5,'CPU-INTEL CELERON G4900 DUAL CORE(3.10CGHZ)',2300),(42,'Intel Core i5-9400 Processor (9M Cache, up to 4.10 GHz)','With the power and responsiveness of Intel® Turbo Boost Tech',5,'CPU-INTEL CORE I5-9400 (2.90GHZ)',10350),(43,'HP Pavilion x360 – 14-cd0068tx (4QK23PA) Intel Core i5 14-inch 2-in-1 Convertible Laptop (Gold Metal','Be free to create, connect and share with the new Pavilion x',16,'LT-HP PAVILION 14-CD0068TX X360(4QK23PA) I5 NVIDIA',48990),(44,'Dell Inspiron 13 7373 13.3-inch Intel Core i7 2-in-1 Convertible Windows Laptop (Era Gray)','13-inch 2-in-1 with expansive views on a thin-bezel screen. ',16,'LT-DELL INSPIRON 13 7373-I78550U TOUCH 2 IN 1 GREY',68990),(45,'Lenovo Yoga Book ZA150149PH Intel Intel Atom x5 10.1? Windows 10 Pro 2-in-1 Tablet (Carbon Black)','Explore Yoga Book with Windows, a groundbreaking 2-in-1 prod',16,'LT-LENOVO YOGA BOOK (ZA150149PH) CARBON BLACK',34999),(46,'Acer Aspire E ES1-432-P0KC Intel Quad Core 14-inch Windows 10 Laptop with Office 365 (Midnight Black','Aspire ES series notebooks inject a fresh blast of color1 an',14,'LT-ACER ASPIRE ES1-432-P0KC 365 PQC MIDNIGHT BLACK',20999),(47,'Lenovo Ideapad 320-14IAP 80XQ003KPH Intel Pentium Quad Core N4200 14? Windows 10 Laptop (Black)','Everything about the Ideapad 320 is designed to simplify you',14,'LT-LENOVO 320-14IAP (80XQ003KPH) PQC BLACK',19495),(48,'Lenovo Ideapad 320-14IAP 80XQ003JPH Intel Pentium Quad Core N4200 14? Windows 10 Laptop (Gray)','Everything about the Ideapad 320 is designed to simplify you',14,'LT-LENOVO 320-14IAP (80XQ003JPH) PQC GREY',19495),(49,'ASUS ZENBOOK UX533FD-A9110T Intel Core I5 GeForce GTX 1050 15.6-inch Windows 10 Laptop (ROYAL BLUE)','Creativity. Style. Innovation. These are the qualities that ',18,'LT-ASUS ZENBOOK UX533FD-A9110T I5 BLUE',74995),(50,'ASUS ROG ZEPHYRUS S GX531GX-ES005T Intel Core I7 GeForce RTX 2080 15.6-inch Windows 10 Laptop (BLACK','After redefining ultra-slim gaming laptops with the original',18,'LT-ASUS ROG ZEPHYRUS S GX531GX-ES005T BLACK',189995),(51,'ASUS ROG ZEPHYRUS GM501GS-EI002T Intel Core I7 GTX 1070 15.6-inch Windows 10 Laptop (BLACK METAL)','ROG Zephyrus M picks up where its predecessor, ROG Zephyrus,',18,'LT-ASUS ROG ZEPHYRUS GM501GS-EI002T BLACK METAL',139995),(52,'HP ENVY 13-AD038TX (2GD27PA) 13-Inch Intel Core I5 GeForce MX150 Windows 10 Laptop (SILVER)','This is an all-aluminium laptop aside from the glass coverin',13,'LT-HP ENVY 13-AD038TX (2GD27PA) SILVER',51390),(53,'HP ENVY 13-AD037TX (2GD26PA) 13-inch Intel Core I5 GeForce MX150 Windows 10 Laptop (GOLD)','Elegance and durability are crafted in a thin and light, all',13,'LT-HP ENVY 13-AD037TX (2GD26PA) GOLD',51390),(54,'Lenovo IdeaPad 330-15ICH 81DC00D2PH Intel Core I3-7130U 4GB DDR4 Intel HD Graphics 620 Windows 10 La','Lenovo IdeaPad 330-15ICH 81DC00D2PH Intel Core I3-7130U 4GB ',13,'LT-LENOVO 330-15IKB (81DC00D2PH) I3 GREY',27995),(55,'HP ENVY 13 AD111TX-2LS51PA Intel Core I5 GeForce MX 150 Intel HD Graphics 13-inch Windows 10 Laptop ','HP ENVY 13 AD111TX-2LS51PA Intel Core I5 GeForce MX 150 Inte',17,'LT-HP ENVY 13-AD111TX (2LS51PA) SILVER',58990),(56,'MSI PS42 MODERN 8RA-204PH Intel Core I7 GeForce MX 250 Windows 10 Laptop (SILVER)','Crafted in ultra-light chassis with hair-brushed aluminum, c',17,'LT-MSI PS42 MODERN 8RA-204PH I7 512GB SSD SILVER',74995),(57,'SECURE 3000VA UPS (BLACK)','Input Voltage: 220VAC\r\nFrequency: 50hz – 60hz\r\nOutput Voltag',19,'UPS-SECURE 3000VA BLK',5200),(58,'SECURE 2000VA UPS (BLACK)','Input Voltage: 220VAC\r\nFrequency: 50hz – 60hz\r\nOutput Voltag',19,'UPS-SECURE 2000VA BLK',4050),(59,'A4TECH PK-635G ANTI-GLARE 16MP W/MIC USB WEBCAM','• CMOS 640×480 350K Pixels, Auto White Balance, Focus Range ',20,'CAM-A4TECH PK-635G 16MP W/MIC USB',600),(60,'TRANSCEND DRIVEPRO 50 CAR CAMCORDER','Introducing Transcend’s most compact dash camera yet–the Dri',20,'DIGICAM-TRANSCEND DRIVEPRO 50 CAR CAMCORDER',4699),(61,'DIGICAM-TRANSCEND DRIVEPRO 50 CAR CAMCORDER','4.5mm diameter OFC wire core\r\n2.4A fast charging and data tr',21,'CI-ACC-RECCI VELOCITY RCT-N120 TYPE-C CAB',395),(62,'RECCI Velocity RCM-N120 Micro USB Data Cable','4.5mm diameter OFC wire core\r\n2.4A fast charging and data tr',21,'CI-ACC-RECCI VELOCITY RCM-N120 MICRO USB CAB',395),(63,'WACOM INTUOS PHOTO CTH-490/K2 GRAPHIC TABLET','Create memorable images and beautiful photo books with the e',22,'PENTABLET-INTUOS PHOTO CTH-490/K2 SMALL BLACK',5750),(64,'WACOM INTUOS MEDIUM CTH-690K0 GRAPHIC TABLET','Tablet Size: 275 x 222 x 10 mm (10.8 x 8.7 x 0.4 in)\r\nErgono',22,'PENTABLET-INTUOS ART MEDIUM CTH-690K0 BLK',10600),(65,'SteelSeries Arctis Pro with GameDAC Hi-Res Gaming Audio System','Each component of the Arctis Pro + GameDAC Hi-Res gaming aud',23,'HS-STEELSERIES ARCTIS PRO WITH GAMDAC',12100),(66,'SteelSeries ARCTIS PRO Wireless Gaming Headset (Black)','Dual Wireless: 2.4G lossless + Bluetooth\r\nIndustry-leading h',23,'HS-STEELSERIES ARCTIS PRO WIRELESS BLK',17150),(67,'SteelSeries Apex M750 Gaming Mechanical Keyboard','The Apex M750 combines showstopping lighting effects and cru',24,'KB-STEELSERIES APEX M750 PRISM RGB MECH',7100),(68,'HyperX Alloy Core RGB Membrane Gaming Keyboard','HyperX’s signature radiant light bar and smooth, dynamic RGB',24,'KB-KINGSTON HYPERX ALLOY CORE RGB',3100),(69,'Viewsonic VX2458-mhd 24-inch Full HD Monitor with FreeSync','The ViewSonic® VX2458-mhd is a 24” (23.6” Viewable) Full HD ',25,'MN-VSONIC 23.6\" VX2458-MHD FREESYNC LED BLK',9995),(70,'Philips 31.5-inch Full HD Curved VA LCD monitor with FreeSync (328E9QJAB/71)','Experience real immersion with Philips 31.5-inch Full HD Cur',25,'MN-PHILIPS 31.5 328E9QJAB BLK',14900),(71,'SteelSeries RIVAL 710 RGB Gaming Mouse with OLED screen','(Prices are subject to change without any prior notice and a',26,'MOUSE-STEELSERIES RIVAL 710 RGB BLK',4150),(72,'SteelSeries RIVAL 310 PUBG Edition Gaming Mouse','The Limited-Edition Rival 310 PUBG Edition featuring the ico',26,'MOUSE-STEELSERIES RIVAL 310 PUBG ED.',2900),(73,'SteelSeries QcK Prism Dota 2 Edition RGB Gaming Mousepad','Official Dota 2 RGB gaming mousepad\r\n2-zone RGB for in-game ',27,'MOUSE PAD-STEELSERIES QCK PRISM DOTA 2 RGB',2250),(74,'D.Va Razer Goliathus Gaming Mouse Pad','Soft gaming mouse mat designed for hardcore gamers featuring',27,'MOUSE PAD-RAZER GOLIATHUS M D.VA EDITION',1100),(75,'Ubiquiti Unifi 802.11ac PRO Access Point (UAP-AC-PRO)','The UniFi AC Pro AP features the latest Wi-Fi 802.11ac, 3×3 ',28,'NET-UBIQUITI UNIFI ACCESS POINT AC (UAP-AC-PRO)',9000),(76,'D-Link COVR-C1203 Dual Band Whole Home Mesh Wi-Fi System','Introducing Covr, the seamless Wi-Fi solution that’s the per',28,'NET-DLINK COVR-C1203',10995),(77,'ASUS ZENPOWER PINK 10050MAH POWERBANK W/ BUMPER CASE','Battery Type : Lithium-ion rechargeable cell\r\nInput Power : ',29,'ACC-TABLET-ASUS ZENPOWER PINK W/ BUMPER CASE',950),(78,'ASUS ZENPOWER BLUE 10050mAh POWERBANK W/ BUMPER CASE','Battery Type : Lithium-ion rechargeable cell\r\nInput Power : ',29,'ACC-TABLET-ASUS ZENPOWER BLUE W/ BUMPER CASE',950),(79,'HP OJ 7110 WIDE FORMAT Printer','Widen your printing possibilities with an affordable, reliab',30,'PRNTR-HP OJ 7110 WIDE FORMAT',9000),(80,'HP LJ PRO M130A Printer','Print professional documents from a range of mobile devices,',30,'PRNTR-HP LJ PRO M130A',7670),(81,'InFocus IN114v XGA DLP Projector','Confidently beam your content with the big power and unbeata',31,'PRJCTR-INFOCUS IN114V XGA HDMI',23850),(82,'InFocus IN112xv DLP Projector','none',31,'RJCTR-INFOCUS IN112XV 3800 ANSI LUMENS W/ BAG',16950),(83,'LEAD 3D 5.1 USB Sound Card Green','Optimizes the sound according to the style of music (such as',32,'SC-LEAD 3D 5.1 USB GREEN',195),(84,'LEAD 3D 5.1 USB Sound Card Blue','Optimizes the sound according to the style of music (such as',32,'SC-LEAD 3D 5.1 USB BLUE',195),(85,'SC-LEAD 3D 5.1 USB BLUE','Logitech G560 LIGHTSYNC gaming speakers immerse you in the a',33,'SP-LOGITECH G560 LIGHTSYNC GAMING 2.1 BLK',10100),(86,'Edifier MP100 Mini Bluetooth Speaker (Yellow)','Bluetooth 4.0 and microSD functionality\r\n20 hour battery lif',33,'SP-EDIFIER MP100 PORTABLE YLW BLUETOOTH',2080),(87,'SP-EDIFIER MP100 PORTABLE YLW BLUETOOTH','The simple way to add extra, high-speed storage to your devi',34,'UD-SANDISK 64GB ULTRA FIT USB3.0/3.1',600),(88,'SANDISK 64GB ULTRA DUAL DRIVE M3.0/OTG (SDDD3-064G-G46) TRANSPARENT FLASH DRIVE','The SanDisk Ultra® Dual Drive m3.0 makes it easy to transfer',34,'UD-SANDISK 64GB ULTRA DUAL USB DRIVE M3.0/OTG',600),(89,'RECCI Caesar RC-K01 iPhone X Case','Premium PC material, solid and durable\r\nLeather-like texture',35,'CI-ACC-RECCI CAESAR RC-K01 IPHONE X CASE',1195),(90,'RECCI Duke RC-L01 iPhone X Phone Case','Fashion & practical mobile stander\r\nTPU material with comfor',35,'CI-ACC-RECCI DUKE RC-L01 IPHONE X CASE',1195),(91,'APPLE IPHONE XS MAX SPACE GREY 256GB','none',36,'CEL-APPLE IPHONE XS MAX S.GRAY 256GB',84990),(92,'APPLE IPHONE XS Gold 256GB','none',36,'CEL-APPLE IPHONE XS GOLD 256GB',77490),(93,'Huawei MediaPad T2 7.0 Tablet','The MediaPad T2 7.0’s powerful quad-core 1.5 GHz A7 processo',37,'TABLET-HUAWEI MEDIAPAD T2 7.0',7490),(94,'Kaspersky Internet Security 2019 3 Devices 2 Years Protection','Whatever you do online – on your PC, Mac & Android devices –',38,'SOFT-KASPERSKY INTERNET SECURITY 2019',1600),(95,'Office Home & Business 2019 for PC or Mac','For families and small businesses who want classic Office ap',38,'OS-MS OFFICE HOME AND BUSINESS 2019 PC/MAC',14500),(96,'WINDOWS 10 PROFESSIONAL 64-BIT','With Windows 10 Pro, you’ve got a great business partner. It',39,'OS-WINDOWS 10 PRO 64BIT FPP',12400),(97,'WINDOWS 10 PROFESSIONAL 64-BIT ENG INTERNATIONAL 1PK DVD (FQC-08929)','With Windows 10 Pro, you’ve got a great business partner. It',39,'OS-WINDOWS 10 PRO 64BIT OEM',8300),(98,'Kaspersky Internet Security 2019 3 Devices 2 Years Protection','Whatever you do online – on your PC, Mac & Android devices –',40,'SOFT-KASPERSKY INTERNET SECURITY 2019',1600),(99,'Kaspersky Antivirus 2019 3 Devices 2 Years Protection','Blocks the latest viruses, ransomware, spyware, cryptolocker',40,'SOFT-KASPERSKY ANTIVIRUS 2019',1200),(107,'TP-LINK TL-WN881ND 300MBPS WIRELESS N PCI EXPRESS ADAPTER','Wireless N speed up to 300Mbps makes it ideal for video stre',11,'NET-TP-LINK TL-WN881ND',700),(108,'TP-LINK TG-3468 LAN CARD','10/100/1000Mbps PCIe Adapter\r\n32-bit PCIe interface, saving ',11,'NET-TP-LINK TG-3468',570),(109,'LITE-ON IHAS-124 24X SATA BLK W/ BOX','24X DVD+R 8X DVD+RW 12X DVD+R DL 24X DVD-R 6X DVD-RW 48X CD-',12,'DVDRW-LITEON IHAS-124 24X SATA BLK W/ BOX',800),(110,'Acer Aspire Spin 7 SP714-51-M4E5 Intel Core i7 14? Convertible 2-in-1 Windows 10 Laptop (Black)','Processor: Intel® Core™ I7-7Y75\r\nOperating System: Windows 1',15,'LT-ACER ASPIRE SPIN 7 SP714-51-M4E5',61999),(111,'Acer Aspire Swift 5 SF514-51-50SQ Intel Core i5 14? Windows 10 Laptop (Black)','Processor: Intel® Core™ I5-7200U\r\nOperating System: Windows ',15,'LT-ACER ASPIRE SWIFT 5 SF514-51-50SQ BLACK',45900);
...
insert  into `purchaseorderdetails`(`purchaseorderdetailid`,`productid`,`purchaseorderdetailquantity`,`purchaseorderid`,`purchaseorderdetailprice`) values (1,1,2,1,5500),(2,31,2,2,6400),(3,109,4,2,800),(4,91,5,3,84990),(5,57,2,4,5200);
...
insert  into `purchaseorders`(`purchaseorderid`,`staffid`,`purchaseordername`,`supplierid`,`paymentmethodid`,`shippingmethodid`,`purchaseorderstatus`,`purchaseorderamountpaid`,`purchasetotalorderamount`,`purchaseorderdatereceived`,`purchaseorderdaterequested`,`purchaseordercomment`) values (1,1,'test',1,1,1,'RECEIVED',0,11000,'0001-01-01','2019-11-17','asdasd'),(2,1,'asd',1,1,1,'RECEIVED',0,16000,'0000-00-00','2019-11-17','asdasd'),(3,1,'oasdoaiodia',4,3,2,'PENDING',0,424950,'0000-00-00','2019-11-23','dasd'),(4,1,'PO ADD STOCKS FROM RASI',3,1,3,'RECEIVED',0,10400,'0000-00-00','2019-11-28','THIS IS A COMMENT');
...
insert  into `shippingmethods`(`shippingmethodid`,`shippingmethod`) values (1,'By Bus'),(2,'By Van'),(3,'By Plane'),(4,'By Ship');
...
insert  into `staffs`(`staffid`,`username`,`password`,`contactdetailid`,`basicinformationid`,`staffpositionid`) values (1,'admin','admin',2,1,1),(3,'clarie','clarie',12,5,2);
...
insert  into `subcategories`(`subcategoryid`,`subcategoryname`,`categoryid`) values (1,'Casing',1),(3,'CPU Fan',1),(4,'Mouse',4),(5,'Processor',1),(6,'Motherboard',1),(7,'Memory Modules',1),(8,'Internal Storage',1),(9,'Graphic Card',1),(10,'Power Supply',1),(11,'NIC Cards',1),(12,'Optical Drive',1),(13,'Mainstream',3),(14,'Entry',3),(15,'Modern PC',3),(16,'2 - in 1 Laptops',3),(17,'Premium',3),(18,'Gaming Laptop',3),(19,'AVR and UPS',4),(20,'Camera',4),(21,'Data Cable',4),(22,'Graphic Tablet',4),(23,'Head set',4),(24,'Keyboard',4),(25,'Monitor',4),(26,'Mouse',4),(27,'Mouse pad',4),(28,'Networking Peripherals',4),(29,'Powerbank',4),(30,'Printers and Scanners',4),(31,'Projector',4),(32,'Sound Card',4),(33,'Speaker',4),(34,'Storage Devices',4),(35,'Phone Cases',5),(36,'Smartphone',5),(37,'Tablet',5),(38,'Office Applications',6),(39,'Operating Systems',6),(40,'Security Applications',6);
...
insert  into `suppliers`(`supplierid`,`supplier`,`contactdetailid`) values (1,'Computer World Superstore',4),(2,'Davao Computer',5),(3,'RASI Computer, Inc.',6),(4,'Computer World Marketing',7),(5,'Wei Dynamic Technology Trading',8);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `categories_view` AS select `categories`.`categoryid` AS `Category ID`,`categories`.`categoryname` AS `Category Name` from `categories` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `purchaseorderdetails_view` AS select `purchaseorderdetails`.`purchaseorderdetailid` AS `Purchase Order Detail ID`,`products`.`productname` AS `Product Name`,`purchaseorderdetails`.`productid` AS `Product ID`,`purchaseorderdetails`.`purchaseorderdetailprice` AS `Price`,`purchaseorderdetails`.`purchaseorderdetailquantity` AS `Quantity`,(`purchaseorderdetails`.`purchaseorderdetailquantity` * `purchaseorderdetails`.`purchaseorderdetailprice`) AS `Amount`,`purchaseorderdetails`.`purchaseorderid` AS `Purchase Order ID`,`products`.`productdescription` AS `Product Description`,`products`.`subcategoryid` AS `Sub Category ID`,`products`.`productsku` AS `Produck SKU`,`products`.`productprice` AS `Product Price`,`subcategories`.`subcategoryname` AS `Sub Category Name`,`subcategories`.`categoryid` AS `Category ID`,`purchaseorders`.`staffid` AS `Staff ID`,`purchaseorders`.`purchaseordername` AS `Purchase Order Name`,`purchaseorders`.`supplierid` AS `Purchase Order Supplier ID`,`purchaseorders`.`paymentmethodid` AS `Payment Method ID`,`purchaseorders`.`shippingmethodid` AS `Shipping Method ID`,`purchaseorders`.`purchaseorderstatus` AS `Purchase Order Status`,`purchaseorders`.`purchaseorderamountpaid` AS `Purchase Order Amount Paid`,`purchaseorders`.`purchasetotalorderamount` AS `Purchase Total Order Amount`,`purchaseorders`.`purchaseorderdaterequested` AS `Date Requested`,`purchaseorders`.`purchaseordercomment` AS `Purchase Order Comment`,`suppliers`.`supplier` AS `Supplier`,`suppliers`.`contactdetailid` AS `Supplier Contact Detail ID`,`staffs`.`username` AS `Staff Username`,`staffs`.`password` AS `Staff Password`,`staffs`.`contactdetailid` AS `Staff Contact Detail ID`,`staffs`.`basicinformationid` AS `Staff Basic Information ID`,`staffs`.`staffpositionid` AS `Staff Position ID`,`staffpositions`.`staffposition` AS `Staff Position`,`basicinformations`.`firstname` AS `First Name`,`basicinformations`.`middlename` AS `Middle Name`,`basicinformations`.`lastname` AS `Last Name`,`basicinformations`.`gender` AS `Gender`,`basicinformations`.`birthdate` AS `Birth Date`,`paymentmethods`.`paymentmethod` AS `Payment Method`,`shippingmethods`.`shippingmethod` AS `Shipping Method`,`contactdetails`.`addressid` AS `Supplier Address ID`,`contactdetails`.`contactnumber` AS `Supplier Contact Number`,`contactdetails`.`emailaddress` AS `Supplier Email Address`,`addresses`.`address` AS `Supplier Address`,`addresses`.`city` AS `Supplier City`,`addresses`.`zipcode` AS `Supplier Zip Code`,`addresses`.`province` AS `Supplier Province`,`purchaseorders`.`purchaseorderdatereceived` AS `Date Received` from ((((((((((((`purchaseorderdetails` join `purchaseorders` on((`purchaseorderdetails`.`purchaseorderid` = `purchaseorders`.`purchaseorderid`))) join `products` on((`purchaseorderdetails`.`productid` = `products`.`productid`))) join `suppliers` on((`purchaseorders`.`supplierid` = `suppliers`.`supplierid`))) join `staffs` on((`purchaseorders`.`staffid` = `staffs`.`staffid`))) join `paymentmethods` on((`purchaseorders`.`paymentmethodid` = `paymentmethods`.`paymentmethodid`))) join `shippingmethods` on((`purchaseorders`.`shippingmethodid` = `shippingmethods`.`shippingmethodid`))) join `subcategories` on((`products`.`subcategoryid` = `subcategories`.`subcategoryid`))) join `categories` on((`subcategories`.`categoryid` = `categories`.`categoryid`))) join `contactdetails` on((`suppliers`.`contactdetailid` = `contactdetails`.`contactdetailid`))) join `staffpositions` on((`staffs`.`staffpositionid` = `staffpositions`.`staffpositionid`))) join `basicinformations` on((`staffs`.`basicinformationid` = `basicinformations`.`basicinformationid`))) join `addresses` on((`contactdetails`.`addressid` = `addresses`.`addressid`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `suppliers_view` AS select `suppliers`.`supplierid` AS `Supplier ID`,`suppliers`.`supplier` AS `Supplier`,`contactdetails`.`contactnumber` AS `Contact Number`,`contactdetails`.`emailaddress` AS `Email Address`,`addresses`.`address` AS `Address`,`addresses`.`city` AS `City`,`addresses`.`zipcode` AS `Zip Code`,`addresses`.`province` AS `Province`,`suppliers`.`contactdetailid` AS `contactdetailid`,`contactdetails`.`addressid` AS `addressid` from ((`suppliers` join `contactdetails` on((`suppliers`.`contactdetailid` = `contactdetails`.`contactdetailid`))) join `addresses` on((`contactdetails`.`addressid` = `addresses`.`addressid`))) */;
