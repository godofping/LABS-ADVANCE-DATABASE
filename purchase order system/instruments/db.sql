...
insert  into `productsintransactions`(`productintransactionid`,`transactionid`,`productid`,`soldprice`,`quantity`,`amount`) values (15,13,3,23300,2,46600),(16,14,4,22450,1,22450);
...
insert  into `transactions`(`transactionid`,`customerid`,`transactiondatetime`,`totalamount`,`amounttendered`,`changeamount`,`isvoid`) values (13,2,'0000-00-00 00:00:00',46600,46600,0,0),(14,6,'0000-00-00 00:00:00',22450,22450,0,0);
