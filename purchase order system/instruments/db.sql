...
insert  into `products`(`productid`,`categoryid`,`productname`,`description`,`price`,`stocks`) values (2,25,'JACKSON JS11 DINKY (BLACK)','Swift, deadly and affordable, Jackson JS Series guitars take an epic leap forward, making it easier than ever to get classic Jackson tone, looks and playability without breaking the bank.',13600,0),(3,25,'JACKSON JS32T KELLY (SATIN BLACK)','Part of Jackson\'s J Series, the JS32T Kelly solidbody electric guitar packs a lot of value. A pair of high-output ceramic-magnet humbuckers hits your amplifier with huge tone - just what you need for an aggressive performance. ',23300,10),(4,25,'JACKSON JS32T RHOADS (WHITE)','Swift, deadly and affordable, Jackson JS Series guitars take an epic leap forward, making it easier than ever to get classic Jackson tone, looks and playability without breaking the bank. Upgraded features such as striking aesthetics, new high-output ceramic-magnet pickups, graphite-reinforced maple necks, bound fingerboards and headstocks, and black hardware deliver more for less.',22450,6),(5,25,'ACCENT CS-2 ACOUSTIC GUITAR','CS-2 Accent Guitar : Accent is the new name in affordable, quality-made, and traditionally inspired acoustic folk guitars from Saga. With a host of high-end features combined in true vintage style, Accent Folk guitars are sure to change the way that student guitars are viewed by all and raise the bar of quality and value to a whole new level.',2340,11),(6,25,'TAKAMINE ED1NC ACOUSTIC ELECTRIC GUITAR WITH PICKUP & TUNER','Takamine ED1NC ACOUSTIC ELECT.GTR WTUNER EQ\r\nED1NC comes with a dreadnought shape the sound in a wide dynamic range and deep in every tune. Spruce top and Mahogany wood back and sides. Satin finish with matte lamination comes with pre-amp and TP-E Preamp with built-in tuner.',15525,12),(7,26,'LUDWIG L26223TX3Q NEUSONIC SERIES DRUM SET','NeuSonic Series\r\n\r\nSonically rich for the working-professional\r\n\r\nElevating our sonic palette, Ludwig is proud to introduce a new line of USA drums crafted for the working professional! NeuSonic series drums by Ludwig offers yet another tonally rich option for the drummer looking for reliability and performance for every working professional setting.\r\n\r\nThey feature a cross-over shell de',158000,5),(8,26,'FERNANDO JUNIOR DRUM SET JBJ1045 (WINE RED)','Fernando Junior Drum Set JBJ1045 (Wine Red)\r\n•Fernando Junior Drum Set JBJ1045 (Wine Red)\r\n\r\n•Junior Drum Set\r\n\r\n•JBJ1045\r\n\r\n•Wine Red',13350,10),(9,27,'ARTURIA KEYLAB ESSENTIAL 61 KEYBOARD MIDI CONTROLLER','Arturia Keylab Essential 61 Keyboard Midi Controller\r\n\r\nCreating music in the digital world is sometimes a little challenging. So many distractions, so many new things to learn. KeyLab Essential lets you focus on what’s important…',16875,25),(10,27,'M-AUDIO DIGITAL PIANO 88 KEYS WEIGHTED ACCENT','Professional-level performance, versatility and features at an unexpected value!\r\n\r\nThe M-Audio Accent is an affordable full-sized 88-key digital piano that has the professional features, versatility, natural playing response and rich sound to meet any requirement. Easy to transport and set up, the Accent is ideal for piano students, stage and studio use, schools, theaters, and houses of worship. It has 20 built-in piano voices (such as Grand Piano, Electric Piano, Drawbar Organ, etc.) and the versatility to split or layer three voices simultaneously. The full range of built-in features enables you to play any music and sound great—from classical to jazz to hip-hop to religious. Designed with simplicity and ease of use in mind, the Accent is elegant and subtle, packed with elements that make it easy for you to be at your creative best.',15575,19),(11,28,'BACH TR710DIR TRUMPET','This trumpet is one of the best starters instruments, featuring a great sound and intonation that is expected from instruments of a much higher price tag. As well as that, the Prelude TR710 Trumpet includes a free gig bag, Bach 7C mouthpiece and extras.',21750,20),(12,28,'CONN CAS280 ALTO SAX','The Conn CAS280 Alto Saxophone\'s fluid keywork gives it a relaxed feeling, while its perfect intonation and warm sound make it a welcome instrument both in the concert band or the hands of a soloist. The Conn La Voix II sax\' traditional-sized bell helps saxophonists keep their tone focused and makes blending easy.\r\nIdeal for concert band and solo playing Professional key styling Includes trek-style case Conn mouthpiece Ligature and cap',115650,25),(13,28,'CERVINI HV-100 VIOLIN','Maple back & sides\r\nSpruce top\r\nSolid maple neck and finish\r\nOne-piece back pc\r\nDyed hardwood/standard chinrest\r\nDyed hardwood fingerboard\r\nDyed hardwood nut & saddle\r\nDyed hardwood/standard pegs\r\nAged maple bridge\r\nComposite / Four Built-in Finetuners tailpiece\r\nPainted purfling\r\nTraditional Red finish',4700,39);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `transactions_view` AS select `transactions`.`transactionid` AS `TRANSACTION ID`,`transactions`.`customerid` AS `CUSTOMER ID`,`transactions`.`transactiondatetime` AS `TRANSACTION DATE AND TIME`,`transactions`.`totalamount` AS `TOTAL AMOUNT`,`transactions`.`amounttendered` AS `AMOUNT TENDERED`,`transactions`.`change` AS `CHANGE`,`transactions`.`isvoid` AS `IS VOID`,`customers`.`fullname` AS `FULL NAME`,`customers`.`contactnumber` AS `CONTACT NUMBER`,concat(`transactions`.`transactionid`,`transactions`.`customerid`,`transactions`.`transactiondatetime`,`transactions`.`totalamount`,`transactions`.`amounttendered`,`transactions`.`change`,`customers`.`fullname`,`customers`.`contactnumber`) AS `C` from (`transactions` join `customers` on((`transactions`.`customerid` = `customers`.`customerid`))) */;
