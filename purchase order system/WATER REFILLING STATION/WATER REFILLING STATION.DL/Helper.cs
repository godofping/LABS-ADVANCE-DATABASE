...
namespace WATER_REFILLING_STATION.DL
{
    public class Helper
    {
        public static string ConnectionString { get { return "Server=localhost;port=3306;UID=root;PWD=;database=water_db;Convert Zero Datetime=True"; } }
