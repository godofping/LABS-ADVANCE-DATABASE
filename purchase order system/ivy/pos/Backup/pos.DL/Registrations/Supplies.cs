...
namespace pos.DL.Registrations
{
    public class Supplies
    {
        ...
        {
            return Helper.executeNonQueryBool("update supplies set supplyname = '" + supply.Supplyname + "', supplyunit = '" + supply.Supplyunit + "', '" + supply.Supplyunitprice + "', '" + supply.Supplystocks + "' where supplyid = " + supply.Supplyid + "");
        }
