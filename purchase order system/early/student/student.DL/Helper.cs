...
namespace student.DL
{
    public class Helper
    {
        public static string ConnectionString { get { return "Server=localhost;port=3306;UID=root;PWD=;database=early_students_db;Convert Zero Datetime=True"; } }
